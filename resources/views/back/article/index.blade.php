...
@section('content')
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="mt-3">
            ...
            <table class="table table-striped table-bordered shadow-sm" style="border-collapse: separate; border-spacing: 0; border-radius: 10px;" id="dataTable">
...
@push('js')
    ...
    <script>
        ...
        function deleteArticle(e){
            ...
            Swal.fire({
                title: 'Delete',
                text: "Sure Data Article will be deleted..?",
                icon: 'question',
