...
<body>
    <!-- Bagian Bantuan Start -->
    <section id="home" class="pb-12 min-h-screen bg-cover bg-center" style="background-image: url('{{ url('img/bg-medis.png') }}')">
        ...
        <!-- Konten -->
        <div class="container font-bold mt-24"> <!-- Tambahkan margin top untuk memindahkan teks ke bawah -->
            <div class="w-full px-4 text-center pb-4">
                <h1 class="text-sm font-bold text-white neon-text lg:text-3xl">
                    TIM BANTUAN MEDIS BUMI GORA
                </h1>
                <p class="text-sm font-semibold text-white">
                    FAKULTAS KEDOKTERAN DAN KESEHATAN UNIVERSITAS MATARAM
                </p>
            </div>
            <div class="flex flex-wrap">
                <div class="w-full px-4 self-center lg:w-1/2">
                    <h2 class="text-xl font-bold text-white text-center lg:text-4xl">
                        MENERIMA <span class="text-[#b81417]">JASA TIM MEDIS</span>
                    </h2>
                </div>
                <div class="w-full px-4 self-center lg:w-1/2">
                    <p class="text-white text-center mb-4 lg:text-left">
                        Menerima jasa tim medis dalam berbagai kegiatan seperti:
                    </p>
                    <ul class="text-white grid grid-cols-2 gap-x-4 gap-y-2 list-disc list-inside pb-4">
                        <li>Bakti Sosial Kesehatan</li>
                        <li>Sirkumsisi (Khitanan)</li>
                        <li>Konser Musik</li>
                        <li>Turnamen Olahraga</li>
                        <li>Kegiatan Jalan Sehat</li>
                        <li>Acara Outdoor</li>
                    </ul>
                    <div class="w-full text-center lg:text-left">
                        <p class="text-white pb-4">
                            dan kegiatan-kegiatan lainnya yang membutuhkan tim medis dalam penyelenggaraannya.
                        </p>
                        <button class="text-base font-bold bg-[#7c0b0d] text-white px-4 py-2 hover:bg-[#4e0b0b] rounded-full transition duration-500 hover:shadow-lg">
                            CONTACT US
                        </button>
                    </div>
                </div>
